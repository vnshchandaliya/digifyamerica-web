    ...
    <div className="flex flex-col md:flex-row items-center justify-center gap-6 text-center md:text-left">
      ...
      <footer className="bg-[#1B3C53] text-white Poppins-font px-6 py-12">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
          ...
          <a href="https://www.facebook.com/people/Digify-America/61574315640630/"><FaFacebook className="hover:text-[#FAA533] cursor-pointer" /></a>
            {/* <FaVimeo className="hover:text-white cursor-pointer" />
            <FaLinkedin className="hover:text-white cursor-pointer" />
            <FaGoogle className="hover:text-white cursor-pointer" /> */}
            <a href="https://www.instagram.com/digifyamerica/"><FaInstagram className="hover:text-[#FAA533] cursor-pointer" /></a>
          </div>
          </div>
