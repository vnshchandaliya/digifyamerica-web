...
//         <path d="M3 8h18" />
//       </svg>
      <center><svg xmlns="http://www.w3.org/2000/svg"   width="83" height="83" fill="none" stroke="#2E2E2E" viewBox="0 0 24 24" stroke-width="0.7"  class="size-20" >
  ...
  },
  {
    ...
    svg: (
    <center> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="0.7" stroke="#2E2E2E" class="size-20">
  ...
  },
  {
    ...
    svg: (
      <center><svg viewBox="0 0 24 24" width="64" height="79" fill="none" stroke="#2E2E2E" strokeWidth="0.7" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 max-w-6xl mx-auto">
        {features.map((item, idx) => (
          <div key={idx} className="feature">
            ...
            <h3 className="text-[#FAA533] Poppins-font font-semibold mt-4 text-[22px]">{item.title}</h3>
