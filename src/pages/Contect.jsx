...
                <div>
                  <label htmlFor="firstName" className="block text-sm font-medium text-[#1B3C53]">
                    First Name
                  </label>
                  <div className="mt-1">
                    <input
...
                </div>
                <div>
                  <label htmlFor="lastName" className="block text-sm font-medium text-[#1B3C53]">
                    Last Name
                  </label>
                  <div className="mt-1">
                    <input
...
                </div>
                <div>
                  <label htmlFor="email" className="block text-sm font-medium text-[#1B3C53]">
                    Email
                  </label>
                  <div className="mt-1">
                    <input
...
                </div>
                <div>
                  <label htmlFor="phone" className="block text-sm font-medium text-[#1B3C53]">
                    Phone Number
                  </label>
                  <div className="mt-1">
                    <input
...
                  <label htmlFor="message" className="block text-sm font-medium text-[#1B3C53]">
                    Message
                  </label>
                  <div className="mt-1">
                    <textarea
...
                      name="message"
                      rows="4"
                      className="block w-full border-[gray-300] rounded-md shadow-sm focus:ring-[#1B3C53] focus:border-[#1B3C53] sm:text-sm p-3"
