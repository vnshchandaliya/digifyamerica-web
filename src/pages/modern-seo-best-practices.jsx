     ...
     <div className="container mx-auto px-4 py-12 pt-34 ">
      ...
      <div className=" max-w-4xl mx-auto text-black ">
        ...
        <p className="text-xl leading-relaxed text-black">
         <o className="text-[#FAA533]">Let’s clear the confusion first:</o>  SEO is not dead but your strategy could be. And it is definitely tired of your outdate tactics.
        </p>
        
        <p className="mt-4 leading-relaxed">
          If you are still stuffing keywords into invisible footers, writing blog posts for 
          <o className="text-[#FAA533]"> “Google robots,”</o>  or hiring someone’s cousin who promises to 
         <o className="border-2 border-[#FAA533] bg-[#FAA533] text-white uppercase whitespace-nowrap" > "rank you #1 overnight," </o>  then your SEO is dead. Not because the game is over, but because you are playing with 2009 rules in a 2025 arena.
        </p>
        ...
        <h2 className="text-3xl md:text-4xl font-[300] text-black leading-tight Poppins-font mb-4">
          <span className="text-[#FAA533] ">01.</span> Start with real humans, not algorithms
        </h2>
        <p className="leading-relaxed">
          <strong className='text-[#FAA533]'>Old SEO:</strong> "What are the exact keywords people type into Google and how many times can I cram them into this sentence?"
        </p>
        <p className="leading-relaxed">
          <strong className='text-[#FAA533]'>Modern SEO:</strong> "What questions are my potential customers asking and how can I be the best answer on the internet?"
        </p>
        ...
        <p className="leading-relaxed">
          <strong className='text-[#FAA533]'>Example:</strong> Instead of targeting “best plumber Tampa cheap fast,” write a guide called “How to find a reliable plumber in Tampa without getting overcharged.”
        </p>

        <hr className="my-10 border-t-2 border-gray-200" />

        <h2 className="text-3xl md:text-4xl font-[300] text-black leading-tight  Poppins-font mb-4">
          <span className="text-[#FAA533] ">02.</span> Content quality over content quantity
        </h2>
        <p className="leading-relaxed">You can’t just churn out regular posts and expect Google to hand you a trophy.</p>
        
        <div className="bg-[#FFF5E1] p-6 rounded-lg my-6 border-l-4 border-[#FAA533]">
          <h3 className="text-xl font-semibold mb-2 text-[#FAA533]">Focus on:</h3>
          <ul className="list-disc list-inside space-y-1">
        ...
        <p className="leading-relaxed">
          <strong className='text-[#FAA533]'>Pro tip:</strong> One well-written, genuinely helpful blog post can outperform 10 keyword-stuffed clones any day.
        </p>
        <p className="leading-relaxed">
          <strong className='text-[#FAA533]'>How Digify America helps:</strong> We don’t create content just to fill space. We craft it to attract, inform, and convert with SEO baked right into every word.
        </p>

        <hr className="my-10 border-t-2 border-gray-200" />

        <h2 className="text-3xl md:text-4xl font-[300] text-black Poppins-font leading-tight mb-4">
          <span className="text-[#FAA533] ">03.</span> Mobile-first or bust
        </h2>
        <p className="leading-relaxed">
        ...
        <div className="bg-[#FFF5E1] p-6 rounded-lg my-6 border-l-4 border-[#FAA533]">
          <h3 className="text-xl font-semibold mb-2 text-[#FAA533]">Check:</h3>
          <ul className="list-disc list-inside space-y-1">
        ...
        <div className="bg-[#FFF5E1] p-6 rounded-lg my-6">
          <h3 className="text-xl font-bold mb-2 text-gray-900">Fixes:</h3>
          <ul className="list-disc list-inside space-y-1">
        ...
        <h2 className="text-3xl md:text-4xl font-[300] text-black Poppins-font leading-tight mb-4">
          <span className="text-[#FAA533]  ">04.</span> Technical SEO — Bit complex and totally necessary
        </h2>
        <p className="leading-relaxed">
        ...
        <div className="bg-[#FFF5E1] p-6 rounded-lg my-6 border-l-4 border-[#FAA533]">
          <h3 className="text-xl font-semibold mb-2 text-[#FAA533]">Checklist:</h3>
          <ul className="list-disc list-inside space-y-1">
        ...
        <h2 className="text-3xl md:text-4xl font-[300] text-black Poppins-font leading-tight mb-4">
          <span className="text-[#FAA533] font-[]">05.</span> Link building without being a Gremlin
        </h2>
        <p className="leading-relaxed">Don’t buy backlinks. Just... don’t. That’s black-hat junk from the days of dial-up.</p>
        
        <div className="bg-[#FFF5E1] p-6 rounded-lg my-6 border-l-4 border-[#FAA533]">
          <h3 className="text-xl font-semibold mb-2 text-[#FAA533]">Modern link building means:</h3>
          <ul className="list-disc list-inside space-y-1">
        ...
        <h2 className="text-3xl md:text-4xl font-[300] text-black Poppins-font leading-tight mb-4">
          <span className="text-[#FAA533] font-[]">06.</span> Local SEO for real-world reach
        </h2>
        <p className="leading-relaxed">
        ...
        <div className="bg-[#FFF5E1] p-6 rounded-lg my-6 border-l-4 border-[#FAA533]">
          <h3 className="text-xl font-semibold mb-2 text-[#FAA533]">Essentials:</h3>
          <ul className="list-disc list-inside space-y-1">
        ...
        <h2 className="text-3xl md:text-4xl font-[300] text-black Poppins-font leading-tight mb-4">
          <span className="text-[#FAA533] ">07.</span> Track, Learn, and Adapt
        </h2>
        <p className="leading-relaxed">SEO is not a "set it and forget it" deal but an on-going strategy.</p>
        
        <div className="bg-[#FFF5E1] p-6 rounded-lg my-6 border-l-4 border-[#FAA533]">
          <h3 className="text-xl font-semibold mb-2 text-[#FAA533]">Use:</h3>
          <ul className="list-disc list-inside space-y-1">
        ...
        <div className="bg-[#FFF5E1] text-black p-8 rounded-xl mt-16 text-center shadow-2xl">
          ...
          <h3 className="text-2xl font-[500] mt-8 text-[#FAA533]">Let’s talk. Let’s rank. Let’s win.</h3>
        </div>
      </div>
    </div>
    </>
