        ...
        <main className="bg-white p-6 md:p-8 rounded-2xl shadow-lg space-y-8">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1 text-gray-700 ml-4">
              ...
              <li><strong>Account Information:</strong> Login credentials for service access (always encrypted)</li>
              <li><strong>Project Materials:</strong> Content, images, brand assets provided for project work</li>
            ...
            <ul className="list-disc list-inside space-y-1 text-gray-700 ml-4">
              ...
              <li><strong>Inquiry Information:</strong> Form submissions, chat conversations</li>
            ...
            <ul className="list-disc list-inside space-y-1 text-gray-700 ml-4">
              ...
              <li>Analytics tools on our website and client platforms</li>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1 text-gray-700 ml-4">
              ...
              <li>Providing educational content related to digital marketing</li>
            ...
            <ul className="list-disc list-inside space-y-1 text-gray-700 ml-4">
              ...
              <li>Training our team to better serve client needs</li>
              <li>Developing new services aligned with market demands</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1 text-gray-700 ml-4">
              ...
              <li>Written security policies and procedures</li>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1 text-gray-700 ml-4">
              ...
              <li>Payment processors and accounting systems</li>
              <li>Email and communication platforms</li>
            ...
            <ul className="list-disc list-inside space-y-1 text-gray-700 ml-4">
              ...
              <li>In response to legitimate requests from public authorities</li>
              <li>To detect or prevent fraud or security issues</li>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="p-4 bg-gray-50 rounded-lg shadow-sm">
                ...
                <ul className="list-disc list-inside space-y-1 text-gray-700">
                  ...
                  <li>Analytics cookies that can be disabled through browser settings</li>
                  <li>Marketing cookies that require explicit opt-in</li>
                  <li>Detailed cookie policy available in our Cookie Settings</li>
                </ul>
              </div>
              <div className="p-4 bg-gray-50 rounded-lg shadow-sm">
                <h3 className="text-lg text-gray-800 flex items-center mb-2">
                ...
                <ul className="list-disc list-inside space-y-1 text-gray-700">
                  ...
                  <li>Contact frequency options for different communication types</li>
                  <li>Option to specify preferred communication channels</li>
                  <li>Right to unsubscribe from non-essential communications</li>
                </ul>
              </div>
              <div className="p-4 bg-gray-50 rounded-lg shadow-sm">
                <h3 className="text-lg text-gray-800 flex items-center mb-2">
                ...
                <ul className="list-disc list-inside space-y-1 text-gray-700">
                  ...
                  <li>EU data subject rights respected in accordance with GDPR</li>
                  <li>Regional privacy regulations honored according to client location</li>
                </ul>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <p className="mt-6 text-gray-600">
              Your privacy concerns will be addressed promptly and thoroughly by our dedicated team. Your trust means everything to us. We collect only the information necessary to deliver our services effectively. At Digify America, your privacy is not an afterthought. It's a priority.
            </p>
          </section>
        </main>
      </div>
