  ...
  return (
    <>
      ...
      <p className="mt-4 leading-relaxed">
        Welcome to the hard truth: if your website doesn’t grab attention in three seconds or less, it’s already lost. Let’s break down how you can transform your snoozefest of a site into a high-performance conversion machine—without needing to learn code or sacrifice your sanity. And yes, Digify America can do all of this for you (without judging your current homepage).
      </p>
      
      <hr className="my-10 border-t-2 border-gray-200" />
      
      <h2 className="text-3xl md:text-4xl font-light text-gray-900 leading-tight mb-4">
        <span className="text-blue-600 font-normal">01.</span> Visual design that doesn’t make eyes bleed
      </h2>
      ...
      <div className="bg-blue-50 p-6 rounded-lg my-6 border-l-4 border-blue-400">
        <h3 className="text-xl font-light mb-2 text-blue-800">Fixes:</h3>
      ...
      <p className="leading-relaxed">
        <strong>How Digify America helps:</strong> Our design team knows exactly how to make your brand look sharp without going overboard. We design websites people want to look at and stay on.
      </p>

      <hr className="my-10 border-t-2 border-gray-200" />
      
      <h2 className="text-3xl md:text-4xl font-light text-gray-900 leading-tight mb-4">
        <span className="text-blue-600 font-normal">02.</span> Messaging that doesn’t sound like a robot
      </h2>
      <p className="leading-relaxed">
      ...
      <p className="leading-relaxed">
        <strong>How Digify America helps:</strong> We craft messaging that’s conversational, clear, and aligned with your voice. We tell your brand story like a human and not a legal disclaimer.
      </p>
      
      <hr className="my-10 border-t-2 border-gray-200" />

      <h2 className="text-3xl md:text-4xl font-light text-gray-900 leading-tight mb-4">
        <span className="text-blue-600 font-normal">03.</span> Performance tweaks that make you lightning fast
      </h2>
      <p className="leading-relaxed">
      ...
      <p className="leading-relaxed">
        <strong>How Digify America helps:</strong> We don’t just design pretty pages—we engineer them for speed. We handle all the behind-the-scenes optimizations so your users don’t bounce before the page even loads.
      </p>
      ...
      <ul className="list-disc list-inside space-y-1">
        <li><strong>Track what matters.</strong> Set up Google Analytics to see where people drop off.</li>
        <li><strong>Keep forms short.</strong> Every extra field is a reason to quit.</li>
        <li><strong>Test, tweak, repeat.</strong> Even small changes like button placement or headline wording can mean big results.</li>
      </ul>
      ...
      <div className="bg-gray-900 text-white p-8 rounded-xl mt-16 text-center shadow-2xl">
        <h2 className="text-3xl md:text-4xl font-[300] mb-4">How Digify America can help</h2>
        ...
        <h3 className="text-2xl font-[300] mt-6">Stop losing visitors. Start turning them into customers.</h3>
      </div>
    </div>
    </>
  )
