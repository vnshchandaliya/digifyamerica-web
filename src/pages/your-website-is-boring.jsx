  ...
  return (
    <section className="bg-[#D2C1B6]  text-[#234C6A]">
      ...
      <p className="mt-4 leading-relaxed">
        <o className="text-[#1B3C53]">Welcome to the hard truth:</o> if your website doesn’t grab attention in three seconds or less, it’s already lost. 
        Let’s break down how you can transform your snoozefest of a site into a 
        <o className="border-2 border-[#1B3C53] bg-[#1B3C53] text-white uppercase whitespace-nowrap" > high-performance conversion machine </o> —without needing to learn code or sacrifice your sanity. And yes, Digify America can do all of this for you (without judging your current homepage).
      </p>
      
      <hr className="my-10 border-t-2 border-gray-200" />
      
      <h2 className="text-3xl md:text-4xl font-[300]  leading-tight Poppins-font mb-4">
          <span className="text-[#fff] ">01.</span> Visual design that doesn’t make eyes bleed
      </h2>
      ...
      <p className="leading-relaxed">
        <strong className='text-[#1B3C53]'>How Digify America helps:</strong> Our design team knows exactly how to make your brand look sharp without going overboard. We design websites people want to look at and stay on.
      </p>

      <hr className="my-10 border-t-2 border-gray-200" />
      
     <h2 className="text-3xl md:text-4xl font-[300]  leading-tight  Poppins-font mb-4">
          <span className="text-[#fff] ">02.</span> Messaging that doesn’t sound like a robot
      </h2>
      <p className="leading-relaxed">
      ...
      <p className="leading-relaxed">
        <strong className='text-[#1B3C53]'>How Digify America helps:</strong> We craft messaging that’s conversational, clear, and aligned with your voice. We tell your brand story like a human and not a legal disclaimer.
      </p>
      
      <hr className="my-10 border-t-2 border-gray-200" />

       <h2 className="text-3xl md:text-4xl font-[300]  leading-tight  Poppins-font mb-4">
          <span className="text-[#fff] ">03.</span> Performance tweaks that make you lightning fast
      </h2>
      <p className="leading-relaxed">
        Even if your site looks great and reads like a dream, it won’t matter if it loads slower. Think of this as a Porsche stuck in traffic.
            ...
            <div className="bg-[#234C6A] p-6 rounded-lg my-6 border-l-4 border-[#fff] text-white">
            <h3 className="text-xl font-semibold mb-2 text-[#fff]">Tips:</h3>
        <ul className="list-disc list-inside space-y-1">
      ...
      <p className="leading-relaxed">
        <strong className='text-[#1B3C53]'>How Digify America helps:</strong> We don’t just design pretty pages—we engineer them for speed. We handle all the behind-the-scenes optimizations so your users don’t bounce before the page even loads.
      </p>
     ...
     <h2 className="text-3xl md:text-4xl font-[300]  leading-tight  Poppins-font mb-4">
      ...
      <ul className="list-disc list-inside space-y-1">
        <li> <strong className='text-[#1B3C53]'>Track what matters.</strong> Set up Google Analytics to see where people drop off.</li>
        <li> <strong className='text-[#1B3C53]'>Keep forms short.</strong> Every extra field is a reason to quit.</li>
        <li> <strong className='text-[#1B3C53]'>Test, tweak, repeat.</strong> Even small changes like button placement or headline wording can mean big results.</li>
      </ul>
      ...
      <div className="bg-[#234C6A] text-white  p-8 rounded-xl mt-16 text-center shadow-2xl">
        ...
        <h3 className="text-2xl font-[500] mt-8 text-[#fff]">Stop losing visitors. Start turning them into customers.</h3>
      </div>
    </div>
    </section>
  )
